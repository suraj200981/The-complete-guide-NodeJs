...
const pageNotFound = require("./controllers/pageNotFound.js"); //importing the error controller from error.js
...
/***********routes************/
app.use("/admin", adminRoutes); //using the admin filtered routes. routes is the property of the adminRoutes object, it can be used to access other properties of the object such as the products array
